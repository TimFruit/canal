...
import com.alibaba.otter.canal.client.adapter.rdbsharding.util.DataSourceUtil;
...
public class AdapterShardingDataSourceFactory {
    ...
    public static DataSource newInstance() throws SQLException, ReflectiveOperationException {
    ...
    private static SpringShardingConfiguration resolveYamlConfiguration(File yamlFile) throws ReflectiveOperationException {
        ...
        for(String name: names){
            ...
            Assert.hasText(dataSourceTypeStr,
                    prefix+".type has not value");
